...
const ExperienceForm = ({ updateTitle, updateStartDate, updateEndDate, updateCompany, updateSummary, updateExperienceList }) => {
    return (
        <form className='ExperienceForm cvForm' onSubmit={(e) => updateExperienceList(e)} >
